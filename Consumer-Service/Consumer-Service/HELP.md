...
* The original package name 'com.consumer-service' is invalid and this project uses 'com.consumer_service' instead.
...
* [Getting Started with Distributed Tracing](https://docs.spring.io/spring-boot/3.3.6/reference/actuator/tracing.html)
